...
<tr style="background:white;">
	...
	<td class='text-right' style="background:white;"><input type="text" class="monto4" value="<?php echo number_format(0,2);?>"></td>
	<td></td>
</tr>
<tr style="background:white;">
	<td class='text-right' colspan=4 style="background:white;">IGV (<?php echo 18?>)% </td>
	<td class='text-right' style="background:white;"><input type="text" class="monto5" value="<?php echo number_format(0,2);?>"></td>
	<td></td>
</tr>
<tr style="background:white;">
	<td class='text-right' colspan=4 style="background:white;">EXONERADA </td>
	<td class='text-right' style="background:white;"><input type="text" class="monto1" value="<?php echo number_format($subtotal,2);?>"></td>
	<td></td>
</tr>
