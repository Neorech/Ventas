...
include('is_logged.php');
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, status_producto, date_added, precio_producto,costo_producto,mon_costo,mon_venta,marca,modelo,color,b1,b2,b3,b4,b5,b6,cat_pro,pro_ser,foto1,foto2,foto3,foto4,web,pre_web,descripcion,descripcion1,megusta,nomegusta,precio2,precio3,und_pro) VALUES ('$codigo','$nombre','$estado','$date_added','$precio_venta','$precio_costo','1','1','$marca','$modelo','$color','$prod[1]','$prod[2]','$prod[3]','$prod[4]','$prod[5]','$prod[6]','$cat_pro','1','nuevo.jpg','nuevo.jpg','nuevo.jpg','nuevo.jpg','1','$precio_venta','','','0','0','0','0','$und_pro')";
