...
$consulta22 = "SELECT * FROM clientes ";
$result22 = mysqli_query($con, $consulta22);
$clientes = array();
$i=0;
while ($valor1 = mysqli_fetch_array($result22)) {
    
    $clientes[$i]=$valor1['nombre_cliente'];
    $i=$i+1;
...
$dd2=$ano2."-".$mes2."-".$dia2;
      ...
      ?>
		...
		<div class="panel-heading">
			 ...
			 Buscar Cobros por Cliente:
		</div>        
        </div>   
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                          <label>Nombre del cliente:</label>
                        <input class="textfield10" placeholder="Nombre del cliente" type="text" value="<?php echo $cliente;?>" name="cliente" id="autocomplete-custom-append" data-validate-length-range="4" class="form-control col-md-10" style="float: left;" />
                    ...
                    <thead>
                     <tr style="background-color:#FE9A2E;color:white; ">
                       <th>Nro  </th>
                        ...
                        <th style="background-color:#FE2E64;color:white; ">Tipo de<br> Pago </th>
                        <th style="background-color:#FE2E64;color:white; ">Operacion <br> Y Banco: </th>
...
$moneda=$row['moneda'];
if ($estado_factura<>4){$text_estado="Pagada";$label_class='';}
else{$text_estado="Pendiente";$label_class='';}
                          ...
                          <td class=" "><?php echo $numero_factura;?></td>
                           <td class=" "><?php echo $tipo;?></td>
                            <td class=" "><?php print"$mon ";echo $total_venta;?></td>
                             <td class=" "><?php print"$mon ";echo $deuda;?></td>
                         <td class=" "></td>   
                      <td class=" "></td>
                        <td class=" "></td>
                        <td class=" "></td>
    ...
    $s=$s+1;
        ...
        <tr id="valor1">
                      ...
                      <td class=" "><?php echo $s;?></td>
                        ...
                        <td class=" "></td>
                       <td class=" "></td>
                       <td class=" "><?php print"$mon ";echo $deuda_anterior;?></td>
                       <td class=" "><?php print"$mon ";echo $total_venta;?></td>
                       <td class=" "><?php echo $numero_factura;?></td>
                       <td class=" "><?php echo $tipo;?></td>
...
?>
                    <tr><td></td><td></td><td></td><td></td><td></td><td></td><td><font style="color:blue;">Deuda :</font></td><td><font style="color:red;">S/.<?php echo number_format ($deuda1,2);?></font></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
                  <?php
                  }
                  ?>
                  </table>
