...
?> <div class="x_panel" style="background:#F2F5A9;">
          ...
          <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
				  ...
				  <input type="text" style="background-color:#A9F5D0;color:black;font-size:15pt; font-family:Verdana;" readonly class="form-control input-sm" id="marca" name="marca" value="<?php echo $marca;?>" placeholder="marca">
				</div>
			  </div>
				...
				<div class="col-sm-8">
				  ...
				  <input type="text" style="background-color:#A9F5D0;color:black;font-size:15pt; font-family:Verdana;"  readonly class="form-control input-sm" id="modelo" name="modelo" value="<?php echo $modelo;?>" placeholder="modelo">
				</div>
			</div>
                        <div class="form-group">
				...
				<div class="col-sm-8">
				  ...
				  <input type="text" style="background-color:#A9F5D0;color:black;font-size:15pt; font-family:Verdana;" readonly class="form-control input-sm" id="color" name="color" value="<?php echo $color;?>" placeholder="color">
				</div>
			</div>
