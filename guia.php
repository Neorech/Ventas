...
?>
       <div class="panel panel-info">
		<div class="panel-heading">
                    ...
                    <h2>Datos de la Guía de Remisión:</h2>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <input placeholder="mm/dd/yyyy"  name="fecha"  data-validate-length-range="4" type="date"  class="form-control col-md-10" style="float: left;" id="fecha1"  aria-describedby="inputSuccess2Status3" value="<?php echo $fecha1;?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text"  autocomplete="off" class="form-control"  id="dir_par" name="dir_par" placeholder="Dirección de Partida" value="<?php echo $dir_par;?>">
				</div>
                                 <div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Ubigeo Partida:</label>
                                    <input type="text"  autocomplete="off" class="form-control"  id="UBIGEO_PARTIDA" name="UBIGEO_PARTIDA" placeholder="Ubigeo Partida" value="<?php echo $UBIGEO_PARTIDA;?>">
				</div>
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Peso:</label>
                                    <input type="text" autocomplete="off" class="form-control"  id="PESO" name="PESO" placeholder="Peso" value="<?php echo $PESO;?>">
				</div>
                                 <div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Nro de Paquetes:</label>
                                    <input type="text"  autocomplete="off" class="form-control"  id="NUMERO_PAQUETES" name="NUMERO_PAQUETES" placeholder="Número de paquetes" value="<?php echo $NUMERO_PAQUETES;?>">
				</div>
                            </div>
                            <div class="form-group row">
				...
				<div class="col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <input type="text"  autocomplete="off" class="form-control"  id="NRO_DOCUMENTO_TRANSPORTE" name="NRO_DOCUMENTO_TRANSPORTE" placeholder="Ruc Transporte" value="<?php echo $NRO_DOCUMENTO_TRANSPORTE;?>">
				</div>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label>Razon Social de Transporte:</label>
                                    <input type="text"  autocomplete="off" class="form-control"  id="RAZON_SOCIAL_TRANSPORTE" name="RAZON_SOCIAL_TRANSPORTE" placeholder="Razon Social de Transporte:" value="<?php echo $RAZON_SOCIAL_TRANSPORTE;?>">
				</div>
                                 <div class="col-md-4 col-sm-4 col-xs-12">
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <input type="search" autocomplete="off" class="form-control input-sm" id="dom_lleg" name="dom_lleg" placeholder="Domicilio de Destino" value="<?php echo $dom_lleg;?>">
                                </div>
				<div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Contacto de Destino:</label>
                                    <input type="search" autocomplete="off" class="form-control input-sm" id="cont_lleg" name="cont_lleg" placeholder="Contacto de Destino" value="<?php echo $cont_lleg;?>">
				</div>
				<div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Teléfono de Destino:</label>
                                    <input type="text" autocomplete="off" class="form-control input-sm" id="tel_lleg" name="tel_lleg" placeholder="Teléfono de Destino" value="<?php echo $tel_lleg;?>">
				</div> 
				
				<div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Ubigeo de Destino:</label>
                                    <input type="text"  class="form-control input-sm" id="hor_lleg" name="UBIGEO_DESTINO" placeholder="Ubigeo destino" value="<?php echo $UBIGEO_DESTINO;?>">
				</div>
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <label>Horario de Llegada:</label>
                                    <input type="date"  class="form-control input-sm" id="hor_lleg" name="hor_lleg" placeholder="Horario de Llegada" value="<?php echo $hor_lleg;?>">
				</div>
                            </div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control input-sm" id="vehiculo" name="vehiculo" placeholder="Vehiculo Marca y Placa Nro" value="<?php echo $vehiculo;?>">
				</div>                  
				
				<div class="col-md-4 col-sm-4 col-xs-12"> 
                                    <label>Certificado de Inscripcion Nro:</label>
                                    <input type="text" autocomplete="off" class="form-control input-sm" id="inscripcion" name="inscripcion" placeholder="Certificado de Inscripcion Nro" value="<?php echo $inscripcion;?>">
				</div>
				
				<div class="col-md-4 col-sm-4 col-xs-12">
                                    <label>Licencia de Conducir:</label>
                                    <input type="text" autocomplete="off" class="form-control input-sm" id="lic" name="lic" placeholder="Licencia de Conducir" value="<?php echo $lic;?>">
				</div>
                            </div>
          <?php
          $fecha5="";
