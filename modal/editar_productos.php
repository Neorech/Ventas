		...
		<div class="modal-content" style="background: #F5ECCE;">
		  ...
		  <div class="modal-body" style="height:500px;overflow-y: scroll;">
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control" onChange="multiplicar();" id="mod_costo" name="mod_costo" placeholder="Precio de costo del producto" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
				</div>
			</div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" class="form-control" id="mod_precio" name="mod_precio" placeholder="Precio 1" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8" >
				</div>
			</div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control" id="mod_marca" name="mod_marca" placeholder="Marca">
				</div>
			</div>
                        <div class="form-group">
				<label for="mod_modelo" class="col-sm-3 control-label">Modelo</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control" id="mod_modelo" name="mod_modelo" placeholder="Modelo">
				</div>
			  </div>
                        <div class="form-group">
