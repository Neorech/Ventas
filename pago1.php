      ...
      <div class="right_col" role="main">
		  ...
		  <div class="modal-body" style="background: #E1F5A9;">
			...
			<div id="resultados_ajax2"></div>
                        ...
                        while($row3=mysqli_fetch_array($rs1)){
                            ...
                            if($t>0){
                                ...
                                <label for="mod_deuda" class="col-sm-3 control-label"><?php echo $doc;?> <?php echo $numero;?></label>
                                    ...
                                    <input type="number"  style="background-color: white;width:170px;text-align:right;" class="monto"  onkeyup="sumar();" value="<?php echo number_format($t,2,'.','');?>" id="deuda<?php echo $i;?>" name="deuda<?php echo $i;?>" readonly>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="number"  style="background-color: #F5D0A9;width:170px;text-align:right;" required autocomplete="off" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo $deuda1;?>';}" step="0.1" min="0" max="<?php echo $deuda1;?>" value="<?php echo $deuda1;?>" id="spTotal" name="spTotal" >
