...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_factura, facturas where detalle_factura.activo=1 and products.id_producto=detalle_factura.id_producto and facturas.ven_com=2 and facturas.estado_factura=detalle_factura.tipo_doc and detalle_factura.id_cliente=facturas.id_cliente and detalle_factura.numero_factura=facturas.numero_factura and facturas.id_factura='".$id_factura."'");
