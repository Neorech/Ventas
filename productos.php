		...
		<div class="panel-heading">
			...
			<h4><i class='glyphicon glyphicon-search'></i>Productos en Sucursal<?php echo $_SESSION['tienda']; ?></h4>
                        <form method="POST" action="alerta.php">
                            Alerta stock:<input type="text" size="5" class="Fields" name="alerta" value="<?php echo $alerta;?>">
                            <input type="hidden" size="5" class="Fields" name="precio2" value="<?php echo $precio2;?>">
                            <input type="hidden" size="5" class="Fields" name="precio3" value="<?php echo $precio3;?>">
