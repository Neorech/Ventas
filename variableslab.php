        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
           ...
           <div class="container">
			...
			<h4><i class='glyphicon glyphicon-search'></i> Buscar variables descansos</h4>
                    </div>
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Buscar variables" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
