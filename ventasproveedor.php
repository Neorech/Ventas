...
?>
    <div class="row">
		...
		<div class="panel-heading">
                    ...
                    <h2>Buscar Compras por Proveedor:</h2>
		</div>        
            </div>         
            <form  name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="ventasproveedor1.php">
                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    ...
                    <input placeholder="Nombre del proveedor" type="text" value="<?php echo $proveedor;?>" name="proveedor" id="autocomplete-custom-append" data-validate-length-range="4" class="form-control col-md-10" style="float: left;" />
